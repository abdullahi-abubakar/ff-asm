...
class TestIntegrationCreate:
    ...
    def test_create_with_all_fields_returns_200(self, integrations1: IntegrationClient):
        ...
        assert resp.status_code == 200, f"POST /integrations: {resp.status_code} {resp.text}"
...
class TestAssetCreate:
    ...
    def test_create_with_all_fields_returns_200(self, integration_u1: dict, assets1: AssetClient):
        ...
        assert resp.status_code == 200, f"POST /assets: {resp.status_code} {resp.text}"
    ...
    def test_same_asset_name_allowed_across_different_integrations(
        ...
        assert resp_i1.status_code == resp_i2.status_code == 200
...
class TestAssetRead:
    ...
    def test_get_nonexistent_asset_returns_404(self, assets1: AssetClient):
        resp = assets1.get("00000000-0000-0000-0000-000000000000")
        assert resp.status_code == 404
